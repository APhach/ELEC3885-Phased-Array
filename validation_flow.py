...
import sip
import threading
import validation_flow_epy_block_0_0_0_0 as epy_block_0_0_0_0  # embedded python block
import validation_flow_epy_block_0_0_1 as epy_block_0_0_1  # embedded python block
...
class validation_flow(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "validation_flow")
        ...
        self._noise_voltage_range = qtgui.Range(0, 60, 1, 0, 200)
        ...
        self.digital_glfsr_source_x_0 = digital.glfsr_source_b(15, True, 0, 1)
        ...
        self.blocks_file_sink_1_1 = blocks.file_sink(gr.sizeof_gr_complex*1, 'temp_symbols.bin', False)
        self.blocks_file_sink_1_1.set_unbuffered(False)
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, 'temp_bits.bin', False)
        self.blocks_file_sink_1.set_unbuffered(False)
        self.blocks_add_xx_0 = blocks.add_vcc(1)
        self.blocks_add_const_vxx_1 = blocks.add_const_ff((-1))
        self.blocks_add_const_vxx_0 = blocks.add_const_ff(0.5)
        self.analog_noise_source_x_0 = analog.noise_source_c(analog.GR_GAUSSIAN, noise_voltage, 0)
        ...
        self.connect((self.digital_costas_loop_cc_0, 0), (self.blocks_file_sink_1_1, 0))
        ...
        self.connect((self.digital_glfsr_source_x_0, 0), (self.epy_block_0_0_0_0, 0))
...
def main(top_block_cls=validation_flow, options=None):
