...
class TestFlow1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "TestFlow1")
        ...
        self._tx_atten_range = qtgui.Range(0, 60, 1, 40, 200)
        ...
        self._gain_range = qtgui.Range(0, 80, 1, 30, 200)
...
def main(top_block_cls=TestFlow1, options=None):
